...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modyandexweb_core_path', null, $modx->getOption('core_path') . 'components/modyandexweb/') . 'model/';
            $modx->addPackage('modyandexweb', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modyandexweb/model/schema/modyandexweb.mysql.schema.xml';
